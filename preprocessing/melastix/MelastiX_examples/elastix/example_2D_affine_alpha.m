...
%setenv('LD_LIBRARY_PATH',['/home/ok37/repos/elastix-4.9.0-linux/lib/libANNlib-4.9.so.1' getenv('LD_LIBRARY_PATH')]);
...
function runExampleLena(lenaTrans,lena,p,ind)
	...
	paramsReporter(p)
	[reg,out]=elastix(lenaTrans,lena,[],'elastix_default.yml','paramstruct',p);
