...
switch sample
    case 'TEST1'
        ...
        % individual channel
        img_directory = "/test_images/test1";                % Input image directory        
        output_directory = "/test_images/test1/output";      % Directory to save results
        sample_id = "TEST1";                                 % Sample name/id
        group = "TEST";                                      % Group name/id
