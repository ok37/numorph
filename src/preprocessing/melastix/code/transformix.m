...
if nargin>1
    ...
    if isstruct(parameters)
        ...
        %New: check for initial transforms for all parameters
        if isfield(parameters,'InitTransformParameters')
            %parameters.TransformParameters = horzcat({parameters.InitTransformParameters},...
