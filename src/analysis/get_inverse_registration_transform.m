function [reg_params_inv,reg_img] = get_inverse_registration_transform(reg_params,mov_img_path)
...
parameter_path{1} = fullfile(home_path,'data','elastix_parameter_files',...
                'atlas_registration','inverse','ElastixParameterPointsInverse.txt');
