...
l_table = readtable(fullfile('annotations','cortical_layers','layer1.csv'));
...
l_table = readtable(fullfile('annotations','cortical_layers','layer2_3.csv'));
idx = ismember(input,l_table.index);
if ~isempty(idx)
    l_idx(idx) = 23;
...
l_table = readtable(fullfile('annotations','cortical_layers','layer4.csv'));
idx = ismember(input,l_table.index);
if ~isempty(idx)
    l_idx(idx) = 4;
...
l_table = readtable(fullfile('annotations','cortical_layers','layer5.csv'));
idx = ismember(input,l_table.index);
if ~isempty(idx)
    l_idx(idx) = 5;
...
l_table = readtable(fullfile('annotations','cortical_layers','layer6a.csv'));
idx = ismember(input,l_table.index);
if ~isempty(idx)
    l_idx(idx) = 60;
...
l_table = readtable(fullfile('annotations','cortical_layers','layer6b.csv'));
idx = ismember(input,l_table.index);
if ~isempty(idx)
    l_idx(idx) = 61;
